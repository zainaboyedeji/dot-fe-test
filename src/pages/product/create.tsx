...
const validationSchema = Yup.object().shape({
  ...
  stock: Yup.number().integer().min(0, "Stock must be a non-negative integer").required(),
  description: Yup.string().required("Description is required"),
  imageUrl: Yup.string()
    .url("Image URL must be a valid URL")
    .required("Image URL is required"),
  rating: Yup.number().min(0, "Rating must be greater than or equal to 0").required(),
  reviews: Yup.number().min(0, "Reviews must be greater than or equal to 0").required(),
});
          ...
          {({ isSubmitting }) => (
            <Form className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                />
                <ErrorMessage name="subCategory" component="p" className="text-red-500 text-sm" />
              </div>
              <div>
              ...
              <div>
                ...
                <Field
                  ...
                  min="0"
                />
                <ErrorMessage name="reviews" component="p" className="text-red-500 text-sm" />
              </div>
              <div>
